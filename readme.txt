...
= 1.6.1 =
* Fixed: translations saved into the plugin's own languages folder load again, the same way HivePress core loads its own and its extensions' bundled translations. The System location remains the recommended home for translations because it survives plugin updates.
